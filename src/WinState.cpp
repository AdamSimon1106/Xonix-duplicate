...
#include <iostream>
#include <stdexcept> // corrected from <Exception>

WinState::WinState(sf::RenderWindow& window, GameController& controller, int score)
...
void WinState::handleEvents(sf::Event& ev)
{
...
void WinState::onEnter(GameController&) {}
void WinState::onExit(GameController&) {}
